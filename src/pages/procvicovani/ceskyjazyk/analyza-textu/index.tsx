...
const MathProblemComponent = () => {
  ...
  const generateRandomId = useCallback(() => {
    ...
    do {
      randomId = Math.floor(Math.random() * maxExercises) + 1; // Generate random ID from 1 to 6
      ...
      >
        {['choiceone', 'choicetwo', 'choicethree'].map((choice, index) => (
          <Button
            ...
            disabled={isButtonsDisabled} // Disable the button if all buttons should be disabled
